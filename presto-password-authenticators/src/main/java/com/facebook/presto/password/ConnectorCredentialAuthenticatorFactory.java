...
public class ConnectorCredentialAuthenticatorFactory
    ...
    public PasswordAuthenticator create(Map<String, String> config)
    {
        try {
            Bootstrap app = new Bootstrap(
                    binder -> binder.bind(ConnectorCredentialAuthenticator.class).in(Scopes.SINGLETON));
            ...
            return injector.getInstance(ConnectorCredentialAuthenticator.class);
        }
        catch (Exception e) {
            throwIfUnchecked(e);
