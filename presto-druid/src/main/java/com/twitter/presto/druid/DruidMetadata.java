...
import com.twitter.presto.druid.metadata.DruidColumnType;
        ...
        implements ConnectorMetadata
{
    ...
    {
        return DruidTableHandle.fromSchemaTableName(tableName);
    }
    ...
    public Map<SchemaTableName, List<ColumnMetadata>> listTableColumns(ConnectorSession session, SchemaTablePrefix prefix)
    {
        ...
        for (SchemaTableName tableName : listTables(session, prefix)) {
            ConnectorTableMetadata tableMetadata = getTableMetadata(session, DruidTableHandle.fromSchemaTableName(tableName));
