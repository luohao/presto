...
public class GcsConfigurationUpdater
{
    ...
    public static void updateConfiguration(Configuration config, Optional<GcsCredential> gcsCredential)
    {
        gcsCredential.ifPresent(x -> {
            config.set(GCS_ACCESS_KEY_CONF, x.getTokenString());
        });
    }
}
